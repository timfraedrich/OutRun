//
//  WorkoutPause+ORWorkoutPauseInterface.swift
//
//  OutRun
...
// Note: For documentation see ORWorkoutPauseInterface.
extension WorkoutPause: ORWorkoutPauseInterface {
    ...
    var pauseType: WorkoutPauseType {
        threadSafeSyncReturn { () -> WorkoutPauseType in
            return self._pauseType.value
        }
    }
